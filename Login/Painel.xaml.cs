    ...
    private void BotaoBuscarImagem(object sender, RoutedEventArgs e)
    {
        ...
        switch (nomeEstudante.ToLower())
        {
            ...
            case "yatra":
                imagemAluna.Source =
                    CriarImagem(
                        "https://admin.cnnbrasil.com.br/wp-content/uploads/sites/12/2025/05/gato-laranja-e1748043537291.jpg?w=1200&h=630&crop=1");
                break;
            case "maria":
            ...
            case "rebecca":
                imagemAluna.Source =
                    CriarImagem(
                        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjy2jkGg019HoXnsiZV8ffbmc_EAK5lDYqrw&s");
                break;
            case "joyce":
                imagemAluna.Source =
                    CriarImagem(
    ...
    private async void GerenciarContagemRegressiva()
    {
        ...
        while (contador < tempoMaximo)
        {
          await Task.Delay(1000);
            contador++;
            displayTemporizador.Text = $"Contagem Regressiva: {tempoMaximo - contador}";
        }
